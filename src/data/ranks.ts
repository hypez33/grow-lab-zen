...
export const RANKS: RankDef[] = [
  ...
  },
  {
    ...
    unlockText: '20 Ernten und 200g verkauft.',
    icon: '🛵',
    color: 'text-cyan-300',
    requirements: { totalHarvests: 20, totalGramsSold: 200 },
    reward: { budcoins: 1000, label: '+1.000 $ Starter-Boost' },
  },
  {
    id: 'regular_supplier',
    name: 'Regular Supplier',
    description: 'Stamm-Kunden zählen auf dich.',
    unlockText: '5 Kunden, 1.500g verkauft, Level 5.',
    icon: '📦',
    color: 'text-sky-300',
    requirements: { customers: 5, totalGramsSold: 1500, level: 5 },
    reward: { budcoins: 3000, label: '+3.000 $' },
  },
  {
